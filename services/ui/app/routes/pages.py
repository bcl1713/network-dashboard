...
async def _read_form(request: Request) -> dict[str, Any]:
    ...
    # Clean up any remaining "None" strings in optional fields
    optional_fields = [
        "description", "source_host", "source_subnet", "destination",
        "destination_subnet", "protocol", "message_match", "notes", "expires_at"
    ]
